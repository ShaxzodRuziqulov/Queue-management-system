...
public interface BookingMapper extends EntityMapper<BookingDto, Booking> {
    ...
    @Mapping(target = "customerAccountId", source = "customerAccount.id")
    @Mapping(target = "customerFirstName", source = "customer.firstName")
    @Mapping(target = "customerLastName", source = "customer.lastName")
    @Mapping(target = "customerMiddleName", source = "customer.middleName")
    ...
    @Mapping(target = "customerAccount", ignore = true)
